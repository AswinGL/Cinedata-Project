    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.CharField(choices=[('Mollywood', 'Mollywood'), ('Kollywood', 'Kollywood'), ('Tollywood', 'Tollywood'), ('Bollywood', 'Bollywood'), ('Hollywood', 'Hollywood'), ('Sandalwood', 'Sandalwood')], max_length=20)),
                ('proffession', models.CharField(choices=[('Actor', 'Actor'), (' Actress', 'Actress'), ('Director', 'Director'), ('Music Director', 'Music Director'), ('Producer', 'Producer')], max_length=50)),
            ],
            options={
                'verbose_name': 'Artist',
